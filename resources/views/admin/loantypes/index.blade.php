...
@section('pagetitle','Samepage Dashboard - Loantypes')
@section('content')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">LoanTypes</li>
                </ul>
            </div>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{route('dashboard.loantypes.add')}}" class="btn btn-sm fw-bold btn-primary" >Create</a>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="card-px py-20 my-10 table-responsive">
                        <h3 class="fs-2x fw-bold mb-10">Loan Types</h3>
                        <table class="table" id="loantypetable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th >{{__('Name')}}</th>
...
$(document).ready(function() {
    $("#loantypetable").DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('dashboard.loantypes.list') !!}',
        columns: [
