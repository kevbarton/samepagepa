...
@section('pagetitle','Samepage Dashboard - Create Personal Other type')
@section('content')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Create Personal Other Type</li>
                </ul>
            </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="card-px py-20 my-10 table-responsive">
                        <h3 class="fs-2x fw-bold mb-10">Create Personal Other Type</h3>
                        <form action="{{route('dashboard.personalothertypes.save')}}" method="post" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                            @csrf
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{route('dashboard.personalothertypes.index')}}" class="btn btn-light me-3">Cancel</a>
