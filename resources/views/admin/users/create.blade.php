...
@section('pagetitle','Samepage Dashboard - Create Loan type')
@section('content')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Create Loan Type</li>
                </ul>
            </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="card-px py-20 my-10 table-responsive">
                        <h3 class="fs-2x fw-bold mb-10">Create Loan Type</h3>
                        <form action="{{route('dashboard.loantypes.save')}}" method="post" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                            @csrf
