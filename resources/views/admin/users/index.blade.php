...
@section('pagetitle','Samepage Dashboard - Users')
@section('content')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{route('dashboard.users.add')}}" class="btn btn-sm fw-bold btn-primary" >Create</a>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="card-px py-20 my-10 table-responsive">
                        <h3 class="fs-2x fw-bold mb-10">Users</h3>
