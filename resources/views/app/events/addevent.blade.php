...
@section('content')
<form action="{{route('app.events.save')}}" method="post" class="add-event-form">
...
<div class="add-event-form-wrapper">
                        ...
                        <div class="mb-3 d-flex field-group align-items-center gap-3">
                            ...
                            <div class="field-row repeat-dropdown-wrapper">
                                ...
                                <div class="dropdown">
                                    ...
                                    <input type="hidden" name="repeat" id="repeat" value="No Repeat" value="{{old('repeat','')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-footer text-left pt-3 mt-3 add-event-footer d-flex align-items-center gap-3">
                            ...
                            <div class="upload-btn ">
                                ...
                                <label for="submit" class="form-label btn btn-dark text-light mb-0">Add Event</label>
