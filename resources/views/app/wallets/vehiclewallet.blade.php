...
@section('content')
    <form action="{{route('app.wallets.savevehicle')}}" class="form" method="post">
        @csrf   
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="vehicle_registration" name="vehicle_registration" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="vehicle_make" class="form-label">Make</label>
                    <input type="text" class="form-control" id="vehicle_make" name="vehicle_make" placeholder="" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="mot_renewal_date" name="mot_renewal_date" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="mot_reminder_date" class="form-label">Reminder Date</label>
                    <input type="date" class="form-control" id="mot_reminder_date" name="mot_reminder_date" placeholder="" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="service_garage" name="service_garage" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="service_telephone_number" class="form-label">Telephone Number</label>
                    <input type="text" class="form-control" id="service_telephone_number" name="service_telephone_number" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="service_cost" class="form-label">Cost</label>
                    <input type="text" class="form-control" id="service_cost" name="service_cost" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="service_last_date" class="form-label">Last Date</label>
                    <input type="date" class="form-control" id="service_last_date" name="service_last_date" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="service_next_date" class="form-label">Next Date</label>
                    <input type="date" class="form-control" id="service_next_date" name="service_next_date" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="service_reminder_date" class="form-label">Reminder Date</label>
                    <input type="date" class="form-control" id="service_reminder_date" name="service_reminder_date" placeholder="" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="roadside_assistance_company_name" name="roadside_assistance_company_name" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="roadside_assistance_amount" class="form-label">Amount</label>
                    <input type="text" class="form-control" id="roadside_assistance_amount" name="roadside_assistance_amount" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="roadside_assistance_telephone_number" class="form-label">Telephone Number</label>
                    <input type="text" class="form-control" id="roadside_assistance_telephone_number" name="roadside_assistance_telephone_number" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="roadside_assistance_policy_number" class="form-label">Policy Number</label>
                    <input type="text" class="form-control" id="roadside_assistance_policy_number" name="roadside_assistance_policy_number" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="roadside_assistance_renewal_date" class="form-label">Renewal Date</label>
                    <input type="date" class="form-control" id="roadside_assistance_renewal_date" name="roadside_assistance_renewal_date" placeholder="" >
                </div>
                <div class="mb-3">
                    <label for="roadside_assistance_reminder_date" class="form-label">Reminder Date</label>
                    <input type="date" class="form-control" id="roadside_assistance_reminder_date" name="roadside_assistance_reminder_date" placeholder="" >
                </div>
                <div class="mb-3">
