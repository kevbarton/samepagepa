...
@section('backlink',route('app.user.editprofile'))
@section('content')
...
<div class="page-title mt-4">
    <h1 class="text-primary h4 text-center mb-0 px-4 page-title text-dark">Upload a photo</h1>
    <a href="{{route('app.user.editprofile')}}" class="btn-close btn-close-white btn-nav-small" aria-label="Close"></a>
</div>
...
@csrf
    ...
    <div class="flex-grow-1 justify-content-center align-items-center d-flex flex-column">
            ...
            <label for="img" class="form-label mb-0">
                <div class="image-preview">
                    @if(auth()->user()->getFirstMediaUrl('avatar'))
                        <img src="{{auth()->user()->getFirstMediaUrl('avatar','thumb')}}" alt="" id="avatar"/>
                    @endif
                </div>
            </label>
        ...
        <div class="text-center">
            <label for="certificate" class="form-label text-dark">Upload profile photo</label>
        </div>
        <div class="progress">
    ...
    <div class="form-footer text-center">
        <a href="{{route('app.user.calendar')}}" class="btn btn-primary">Next</a>
    </div>
      ...
      document.getElementById('crop').addEventListener('click', function () {
        ...
        if (cropper) {
          ...
          canvas.toBlob(function (blob) {
            ...
            $.ajax('{{route('app.user.profilephotoupload')}}', {
              method: 'POST',
              data: formData,
              processData: false,
              contentType: false,
